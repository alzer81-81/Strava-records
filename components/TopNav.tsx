...
const windowOptions = ["WEEK", "MONTH", "LAST_2M", "LAST_6M", "YEAR", "LAST_365"] as const satisfies readonly WindowType[];
        ...
        {showTimeframe ? (
          <div className="flex items-center gap-2 rounded-full border border-black/10 bg-white px-2 py-1.5 shadow-soft md:gap-3 md:px-3">
            ...
            <div className="relative">
              <select
                value={current}
                onChange={(event) => applyWindow(event.target.value as WindowType)}
